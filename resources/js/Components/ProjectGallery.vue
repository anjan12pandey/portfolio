  ...
  <div class="pb-10 section">
    <div class="container">
      ...
      <div class="filter-menu">
        <ul class="menu-list">
          <li @click="filter('all')" :class="{ active: selectedCat === 'all' }">
            All
          </li>
          <li
    ...
    <div class="custom-container container-fluid">
      ...
      <div class="mb-10 project-section mt-n4">
        <div class="project-responsive row">
          <div
            v-for="preview in previews"
            :key="preview"
            class="singleproject-view col-xl-4 col-md-6"
          >
            <!-- Single Project Start -->
            <div
              v-if="selectedCat === preview.category || selectedCat === 'all'"
              :class="'preview ' + preview.category"
            >
              <div class="single-project">
                <div class="project-images">
                  <inertia-link :href="`/project/${preview.id}`"
...
export default {
  ...
  methods: {
    ...
    filterCategories: function () {
      this.categories = [
        ...new Set(this.previews.map((item) => item.category)),
      ];
    },
  },
  mounted() {

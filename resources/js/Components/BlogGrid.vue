<template>
  ...
  <div class="pb-10 section">
    ...
    <div class="container">
      <!-- Blog Section Start -->
      <div class="mb-10 blog-section mt-n4">
        <div class="row">
          <div
            v-for="(blog, index) in blogs.blogs"
            :key="index"
            :class="blog.column"
          >
            <!-- Single Project Start -->
            <div
              v-if="selectedCat === blog.category || selectedCat === 'all'"
...
export default {
  ...
  methods: {
    ...
    filterCategories: function () {
      this.categories = [
        ...new Set(this.blogs.blogs.map((item) => item.category)),
      ];
    },
  },
  mounted() {
